...
\def\ThesisTitle{Query Rewriting Framework for Translating SQL into Graph Database Query Languages}

% Author of the thesis (you)
\def\ThesisAuthor{Bc. Ivona Oboňová}
...
\def\ThesisTitleCS{Framework pro překlad SQL do dotazovacích jazyků grafových databází}
